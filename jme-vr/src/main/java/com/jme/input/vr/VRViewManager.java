...
public interface VRViewManager {
     ...
     * This method should be called for example from the {@link com.jme.app.state.AppState#render(com.jme.renderer.RenderManager) render} method of an {@link com.jme.app.state.AppState app state}.
     * @see #postRender()
     */
    public void render();
