 ...
 */
package com.jme.input.vr.openvr;
...
import com.jme.system.jopenvr.HmdMatrix34_t;
import com.jme.system.jopenvr.HmdMatrix44_t;
import com.jme.system.jopenvr.JOpenVRLibrary;
import com.jme.system.jopenvr.OpenVRUtil;
import com.jme.system.jopenvr.TrackedDevicePose_t;
import com.jme.system.jopenvr.VR_IVRCompositor_FnTable;
import com.jme.system.jopenvr.VR_IVRSystem_FnTable;
import com.jme.system.jopenvr.VR_IVRTrackedCamera_FnTable;
import com.jme.util.VRUtil;
...
public class OpenVR implements VRAPI {
    ...
    /**
     * Convert specific OpenVR {@link com.jme.system.jopenvr.HmdMatrix34_t HmdMatrix34_t} into JME {@link Matrix4f Matrix4f}
     * @param hmdMatrix the input matrix
     * @param mat the converted matrix
     * @return the converted matrix
     */
    public static Matrix4f convertSteamVRMatrix3ToMatrix4f(com.jme.system.jopenvr.HmdMatrix34_t hmdMatrix, Matrix4f mat){
    ...
    /**
     * Convert specific OpenVR {@link com.jme.system.jopenvr.HmdMatrix44_t HmdMatrix34_t} into JME {@link Matrix4f Matrix4f}
     * @param hmdMatrix the input matrix
     * @param mat the converted matrix
     * @return the converted matrix
     */
    public static Matrix4f convertSteamVRMatrix4ToMatrix4f(com.jme.system.jopenvr.HmdMatrix44_t hmdMatrix, Matrix4f mat){
        mat.set(hmdMatrix.m[0], hmdMatrix.m[1], hmdMatrix.m[2], hmdMatrix.m[3], 
                hmdMatrix.m[4], hmdMatrix.m[5], hmdMatrix.m[6], hmdMatrix.m[7],
                hmdMatrix.m[8], hmdMatrix.m[9], hmdMatrix.m[10], hmdMatrix.m[11], 
