 ...
 */
package com.jme.input.vr.osvr;

import com.jme.app.VREnvironment;
import com.jme.input.vr.HmdType;
import com.jme.input.vr.VRAPI;
import com.jme.input.vr.VRInputAPI;
import com.jme.math.Matrix4f;
import com.jme.math.Quaternion;
import com.jme.math.Vector2f;
import com.jme.math.Vector3f;
import com.jme.renderer.Camera;
import com.jme.system.osvr.osvrclientkit.OsvrClientKitLibrary;
import com.jme.system.osvr.osvrdisplay.OsvrDisplayLibrary;
import com.jme.system.osvr.osvrdisplay.OsvrDisplayLibrary.OSVR_DisplayConfig;
import com.jme.system.osvr.osvrmatrixconventions.OSVR_Pose3;
import com.jme.system.osvr.osvrrendermanageropengl.OSVR_OpenResultsOpenGL;
import com.jme.system.osvr.osvrrendermanageropengl.OSVR_RenderBufferOpenGL;
import com.jme.system.osvr.osvrrendermanageropengl.OSVR_RenderInfoOpenGL;
import com.jme.system.osvr.osvrrendermanageropengl.OSVR_RenderParams;
import com.jme.system.osvr.osvrrendermanageropengl.OSVR_ViewportDescription;
import com.jme.system.osvr.osvrrendermanageropengl.OsvrRenderManagerOpenGLLibrary;
...
public class OSVR implements VRAPI {
    ...
    com.jme.system.osvr.osvrrendermanageropengl.OSVR_GraphicsLibraryOpenGL.ByValue graphicsLibrary;
    ...
    public boolean initVRCompositor(boolean allowed) {
        ...
        grabGLFWContext();
        graphicsLibrary = new com.jme.system.osvr.osvrrendermanageropengl.OSVR_GraphicsLibraryOpenGL.ByValue();
...
*/
    ...
    public Matrix4f getHMDMatrixProjectionLeftEye(Camera cam) {
        ...
        if( eyeMatrix[EYE_LEFT] == null ) {
            ...
            com.jme.system.osvr.osvrdisplay.OsvrDisplayLibrary.osvrClientGetViewerEyeSurfaceProjectionMatrixf(displayConfig, 0, (byte)EYE_LEFT, 0, cam.getFrustumNear(), cam.getFrustumFar(), (short)0, tfb);
    ...
    public Matrix4f getHMDMatrixProjectionRightEye(Camera cam) {
        ...
        if( eyeMatrix[EYE_RIGHT] == null ) {
            FloatBuffer tfb = FloatBuffer.allocate(16);
            com.jme.system.osvr.osvrdisplay.OsvrDisplayLibrary.osvrClientGetViewerEyeSurfaceProjectionMatrixf(displayConfig, 0, (byte)EYE_RIGHT, 0, cam.getFrustumNear(), cam.getFrustumFar(), (short)0, tfb);
