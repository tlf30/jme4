...
import com.jme.app.state.AppState;
import com.jme.app.state.AppStateManager;
import com.jme.asset.AssetManager;
import com.jme.audio.AudioContext;
import com.jme.audio.AudioRenderer;
import com.jme.audio.Listener;
import com.jme.input.InputManager;
import com.jme.input.JoyInput;
import com.jme.input.KeyInput;
import com.jme.input.MouseInput;
import com.jme.input.TouchInput;
import com.jme.input.controls.KeyTrigger;
import com.jme.input.vr.VRAPI;
import com.jme.input.vr.VRInputAPI;
import com.jme.input.vr.openvr.OpenVR;
import com.jme.input.vr.openvr.OpenVRMouseManager;
import com.jme.input.vr.openvr.OpenVRViewManager;
import com.jme.input.vr.osvr.OSVR;
import com.jme.math.ColorRGBA;
import com.jme.math.Quaternion;
import com.jme.math.Vector3f;
import com.jme.post.PreNormalCaching;
import com.jme.profile.AppProfiler;
...
import com.jme.system.AppSettings;
import com.jme.system.JmeContext;
import com.jme.system.JmeContext.Type;
import com.jme.system.jopenvr.JOpenVRLibrary;
import com.jme.system.JmeSystem;
import com.jme.system.NanoTimer;
import com.jme.system.SystemListener;
import com.jme.system.Timer;
import com.jme.system.lwjgl.LwjglDisplayVR;
import com.jme.system.lwjgl.LwjglOffscreenBufferVR;
import com.jme.util.VRGUIPositioningMode;
import com.jme.util.VRGuiManager;
...
public abstract class VRApplication implements Application, SystemListener {
    ...
    */
     ...
     * otherwise.
     *
     * @see #setLostFocusBehavior(com.jme.app.LostFocusBehavior)
     */
    ...
    /**
     * Starts the application in {@link com.jme.system.JmeContext.Type#Display display} mode.
     * @param waitFor if <code>true</code>, the method will wait until the application is started.
     * @see #start(com.jme.system.JmeContext.Type, boolean)
     */
     ...
     * @param contextType the {@link com.jme.system.JmeContext.Type type} of the context to create.
     * @param waitFor if <code>true</code>, the method will wait until the application is started.
