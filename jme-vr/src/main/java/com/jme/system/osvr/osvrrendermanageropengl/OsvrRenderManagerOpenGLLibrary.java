package com.jme.system.osvr.osvrrendermanageropengl;
...
public class OsvrRenderManagerOpenGLLibrary implements Library {
	...
	public static native byte osvrRenderManagerPresentSolidColorf(Pointer renderManager, com.jme.system.osvr.osvrrendermanageropengl.OSVR_RGB.ByValue rgb);
	/**
	 * when you're done.<br>
	 ...
	 * @deprecated use the safer methods {@link #OSVR_Projection_to_OpenGL(java.nio.DoubleBuffer, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue)} and {@link #OSVR_Projection_to_OpenGL(com.sun.jna.ptr.DoubleByReference, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue)} instead
	 */
	@Deprecated 
	public static native byte OSVR_Projection_to_OpenGL(DoubleByReference OpenGL_out, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue projection_in);
	/**
	 * @return True on success, false on failure (null pointer).<br>
	 * Original signature : <code>OSVR_ReturnCode OSVR_Projection_to_OpenGL(double*, OSVR_ProjectionMatrix)</code>
	 */
	public static native byte OSVR_Projection_to_OpenGL(DoubleBuffer OpenGL_out, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue projection_in);
	/**
	 * @return True on success, false on failure (null pointer).<br>
	 * Original signature : <code>OSVR_ReturnCode OSVR_Projection_to_D3D(float[16], OSVR_ProjectionMatrix)</code><br>
	 * @deprecated use the safer methods {@link #OSVR_Projection_to_D3D(java.nio.FloatBuffer, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue)} and {@link #OSVR_Projection_to_D3D(com.sun.jna.ptr.FloatByReference, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue)} instead
	 */
	@Deprecated 
	public static native byte OSVR_Projection_to_D3D(FloatByReference D3D_out, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue projection_in);
	/**
	 * @return True on success, false on failure (null pointer).<br>
	 * Original signature : <code>OSVR_ReturnCode OSVR_Projection_to_D3D(float[16], OSVR_ProjectionMatrix)</code>
	 */
	public static native byte OSVR_Projection_to_D3D(FloatBuffer D3D_out, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue projection_in);
	/**
	 * @return True on success, false on failure (null pointer).<br>
	 * Original signature : <code>OSVR_ReturnCode OSVR_Projection_to_Unreal(float[16], OSVR_ProjectionMatrix)</code><br>
	 * @deprecated use the safer methods {@link #OSVR_Projection_to_Unreal(java.nio.FloatBuffer, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue)} and {@link #OSVR_Projection_to_Unreal(com.sun.jna.ptr.FloatByReference, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue)} instead
	 */
	@Deprecated 
	public static native byte OSVR_Projection_to_Unreal(FloatByReference Unreal_out, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue projection_in);
	/**
	 * @return True on success, false on failure (null pointer).<br>
	 * Original signature : <code>OSVR_ReturnCode OSVR_Projection_to_Unreal(float[16], OSVR_ProjectionMatrix)</code>
	 */
	public static native byte OSVR_Projection_to_Unreal(FloatBuffer Unreal_out, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ProjectionMatrix.ByValue projection_in);
	/**
	 ...
	 * @deprecated use the safer method
         * {@link #osvrCreateRenderManagerOpenGL(com.jme.system.osvr.osvrclientkit.OsvrClientKitLibrary.OSVR_ClientContext, byte[], com.jme.system.osvr.osvrrendermanageropengl.OSVR_GraphicsLibraryOpenGL.ByValue, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.PointerByReference)}
         * instead
	 */
	@Deprecated 
	public static native byte osvrCreateRenderManagerOpenGL(Pointer clientContext, Pointer graphicsLibraryName, com.jme.system.osvr.osvrrendermanageropengl.OSVR_GraphicsLibraryOpenGL.ByValue graphicsLibrary, PointerByReference renderManagerOut, PointerByReference renderManagerOpenGLOut);
	...
	public static native byte osvrRenderManagerPresentRenderBufferOpenGL(Pointer presentState, com.jme.system.osvr.osvrrendermanageropengl.OSVR_RenderBufferOpenGL.ByValue buffer, OSVR_RenderInfoOpenGL.ByValue renderInfoUsed, com.jme.system.osvr.osvrrendermanageropengl.OSVR_ViewportDescription.ByValue normalizedCroppingViewport);
	...
	public static native byte osvrRenderManagerRegisterRenderBufferOpenGL(Pointer registerBufferState, com.jme.system.osvr.osvrrendermanageropengl.OSVR_RenderBufferOpenGL.ByValue renderBuffer);
	/**
