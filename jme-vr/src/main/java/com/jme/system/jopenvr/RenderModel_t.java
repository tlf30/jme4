...
public class RenderModel_t extends Structure {
	 ...
	 */
	public com.jme.system.jopenvr.RenderModel_Vertex_t.ByReference rVertexData;
	 ...
	 */
	public RenderModel_t(com.jme.system.jopenvr.RenderModel_Vertex_t.ByReference rVertexData, int unVertexCount, ShortByReference rIndexData, int unTriangleCount, int diffuseTextureId) {
		super();
