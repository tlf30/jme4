...
import com.jme.system.jopenvr.JOpenVRLibrary.VkInstance_T;
...
public class VR_IVRSystem_FnTable extends Structure {
	...
	public com.jme.system.jopenvr.VR_IVRExtendedDisplay_FnTable.GetDXGIOutputInfo_callback GetDXGIOutputInfo;
	...
	public interface GetProjectionMatrix_callback extends Callback {
		com.jme.system.jopenvr.HmdMatrix44_t.ByValue apply(int eEye, float fNearZ, float fFarZ);
	};
	...
	public interface GetHiddenAreaMesh_callback extends Callback {
		com.jme.system.jopenvr.HiddenAreaMesh_t.ByValue apply(int eEye, int type);
	};
