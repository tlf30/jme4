package com.jme.scene.plugins.fbx.objects;
...
import com.jme.scene.plugins.fbx.ContentTextureKey;
import com.jme.scene.plugins.fbx.ContentTextureLocator;
import com.jme.scene.plugins.fbx.SceneLoader;
	...
	private Image createImage() {
		...
		if(filename != null) {
			...
			if(file.exists() && file.isFile()) {
				...
				Texture tex = null;
				try {
					assetManager.registerLocator(locatorPath, com.jme.asset.plugins.FileLocator.class);
					tex = assetManager.loadTexture(file.getName());
				} catch(Exception e) {} finally {
					assetManager.unregisterLocator(locatorPath, com.jme.asset.plugins.FileLocator.class);
				}
				if(tex != null)
					image = tex.getImage();
			}
